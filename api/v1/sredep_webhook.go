...
//+kubebuilder:webhook:path=/validate-app-operator-com-v1-sredep,mutating=false,failurePolicy=fail,sideEffects=None,groups=app.operator.com,resources=sredeps,verbs=create;update,versions=v1,name=vsredep.kb.io,admissionReviewVersions={v1,v1beta1}
